...
rem 打包
call mvn clean package -DskipTests=true -pl com.whl.demo:demo-eureka,com.whl.demo:demo-feign,com.whl.demo:demo-log,com.whl.demo:demo-token,com.whl.demo:demo-user,com.whl.demo:demo-compound -am -U
...
cd /d "%CURRENT_DIR%\demo-token"
start cmd /k java -jar target\demo-token-1.0-SNAPSHOT.jar
